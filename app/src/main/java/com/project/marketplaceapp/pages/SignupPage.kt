    ...
    Surface {
        Column(modifier = Modifier.fillMaxSize())
        {
            ...
            Column(
                ...
                SignupSection(authViewModel)
                Spacer(modifier = Modifier.height(MaterialTheme.dimens.medium2))
                LoginNow(navController)
            }
...
@Composable
private fun SignupSection(authViewModel: AuthViewModel) {
...
@Composable
private fun LoginNow(navController: NavController) {
    val uiColor = if (isSystemInDarkTheme()) Color.White else Black
    Box(
        modifier = Modifier
